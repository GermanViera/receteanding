        ...
        function buscarRecetaCategoria(q){
            alert("bbbb "+ q);
                                    ...
                                    $.ajax({
                                           ...
                                           alert(data["titulo"]);
                                                                ...
                                                                if(entre){
                                                                    ...
                                                                                                                               document.getElementById("titulo_busqueda").innerHTML="Ups! Sin registros" ;                                                              contenido+='<div class="about_author"><p> No exiten recetas con el criterio seleccionado</p></div>';                                                            document.getElementById("contenedor_productos").innerHTML=contenido;  
                ...
                function buscarRecetaDeUsuario(q){
                 ...
                 function buscarRecetasGuardadas(usuario){
                 ...
                 function buscarRecetasMeGustan(usuario){
...
function eliminarRecetaMg(receta){
    ...
    $.ajax({
           ...
           complete:function(){
           //corroborarSesion();
           buscarRecetasMeGustan(mi_usuario);
           },
           error: function(data){
           console.log(data);
...
function eliminarReceta(receta){
    ...
    $.ajax({
           ...
           complete:function(){
           //corroborarSesion();
           buscarRecetasGuardadas(mi_usuario);
           },
           error: function(data){
           console.log(data);
           document.getElementById("msg_error").innerHTML="Hubo problemas al procesar la solicitud, verifique su conexi&oacute;n a internet";
